...
<div class="container text-left my-5" data-aos="fade-up">
    ...
    <h1 class="ml-3 mb-2">Kelolah Menu</h1>

    <div class="text-start mb-3 ml-3">
        <a href="{{ route('menu.create') }}" class="btn btn-outline-light">Tambah Menu</a>
    </div>
    ...
    <div class="table-responsive" data-aos="fade-up">
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <img src="{{ asset($item['image']) }}" alt="{{ $item['nama_menu'] }}" class="menu-image">
                    </td>
                    ...
                    <td>
                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('menu.destroy', $item->id) }}" method="POST">
                            <a href="{{ route('menu.edit', $item->id) }}" class="btn btn-outline-light btn-sm">Edit</a>
                            @csrf
                            @method('DELETE')
